...
<head>
<title>Forgot Password &ndash; OneKenya Online Groceries Shop</title>
<?php
    	...
    	<div class="container-fluid">        
            <div class="row align-items-center">
                ...
                <div class="logo col-md-2 col-lg-2 d-none d-lg-block">
                    <a href="index.php">
                    	<img src="assets/images/onekenya.png" alt="" title="" />
                    </a>
                </div>
                <!--End Desktop Logo-->
    ...
    <div id="page-content">
    	...
    	<div class="page section-header text-center">
			<div class="page-title">
        		<div class="wrapper"><h1 class="page-width">Recover your account</h1></div>
      		</div>
		</div>
        <!--End Page Title-->
                          ...
                          <div class="row">
                            <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group">
                                    <label for="CustomerEmail" class="text-center">Enter your <b>email</b> below to receive a password reset link.</label>
                                    <input style="border-radius: 5px" type="email" name="customer[email]" placeholder="" id="CustomerEmail" class="" autocorrect="off" autocapitalize="off" autofocus="">
                                </div>
                            </div>
                          </div>
                          <div class="row">
                            <div class="text-center col-12 col-sm-12 col-md-12 col-lg-12">
                                <button type="submit" style="border-radius: 5px; background-color: green; color: white;" class="btn btn--large mb-4">Reset Password</button>
                            </div>
                         </div>
                     </form>
                    </div>
