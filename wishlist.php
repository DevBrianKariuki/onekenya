    	...
    	<div class="container-fluid">        
            <div class="row align-items-center">
                ...
                <div class="logo col-md-2 col-lg-2 d-none d-lg-block">
                    <a href="index.php">
                    	<img src="assets/images/onekenya.png" alt="OneKenya" title="" />
                    </a>
                </div>
                <!--End Desktop Logo-->
                               ...
                               ?>
                                <tr class="cart__row border-bottom line1 cart-flex">
                                    <td class="cart__image-wrapper cart-flex-item">
                                        <a href="#"><img class="cart__image" width="100" height="100" src="assets/images/product-images/product-image30.jpg" alt=""></a>
                                    </td>
                                    ...
                                    <td class="text-right small--hide cart-price" style="padding-top: 50px">
                                        <div><span class="text-success"><b>In Stock</b></span></div>
                                    </td>
